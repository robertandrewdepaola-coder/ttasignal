...
<style>
    ...
    /* Fix garbled expander arrow text - hide broken icon, use CSS arrow */
    ...
    /* Also hide any SVG arrow that might render as _arr */
    [data-testid="stExpanderToggleIcon"] svg {
        display: none !important;
    }
    
    /* Fix garbled _arr prefix in expander - hide the raw arrow text leak */
    [data-testid="stExpanderToggleIcon"] {
        visibility: visible !important;
    }
    /* Force the marker/arrow to use CSS only, not text */
