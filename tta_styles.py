...
<style>
    ...
    /* Expander summary text - white on dark */
    .stExpander summary, [data-testid="stExpander"] summary {
        color: #FFFFFF !important;
    }
    .stExpander summary span, [data-testid="stExpander"] summary span,
    .stExpander summary p, [data-testid="stExpander"] summary p {
        color: #FFFFFF !important;
    }
    
    /* Content inside expanded sections - ensure readable on dark bg */
    ...
    /* ═══════════════════════════════════════════════════════════════
       NUCLEAR FIX: Kill the garbled _arr text from expander icons
       The _arr prefix is Streamlit's SVG arrow icon text leaking out
       ═══════════════════════════════════════════════════════════════ */
    
    /* Completely hide the toggle icon element */
    ...
    /* Hide any SVG inside it */
    [data-testid="stExpanderToggleIcon"] svg {
        display: none !important;
    }
    
    /* Use CSS list-style for the arrow instead */
    ...
    /* Fallback: if list-style doesn't work, use ::marker */
    [data-testid="stExpander"] details > summary::marker {
        content: "▸ " !important;
        color: #E6EDF3 !important;
    }
    [data-testid="stExpander"] details[open] > summary::marker {
        content: "▾ " !important;
        color: #E6EDF3 !important;
    }
    ...
    /* ═══════════════════════════════════════════════════════════════════════
       INPUT FIELDS - Fix grey/invisible text on dark backgrounds
       ═══════════════════════════════════════════════════════════════════════ */
    ...
    /* Placeholder text - slightly dimmed but still readable */
...
def render_ai_box(content: str, recommendation: str = "", confidence: str = "", provider: str = "") -> str:
    ...
    provider_label = provider if provider else 'AI Analysis'
    ...
    <div class="ai-box">
        <div class="ai-header">
            ...
            <span class="ai-powered">{provider_label}</span>
        </div>
